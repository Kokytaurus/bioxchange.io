...
const subscribeUrl = "https://.us16.list-manage.com/subscribe/post?u=918b60ce5b05d82384c293db0&amp;id=b2af978303";
						...
						<div id="subscription-form-inner">
							...
							<div className="col-xs-12 col-sm-10">
								<div className="form-group is-empty has-success">
									<input ref={node => (this.input = node)} type="email" name="EMAIL" placeholder="Enter your email to receive updates about BioXchange" className="form-control" required />
